...
- fix(skills): remove the human-only menu treatment and its hover jitter by @backnotprop in [#1236](https://github.com/backnotprop/plannotator/pull/1236)
...
**Full Changelog**: https://github.com/backnotprop/plannotator/compare/v0.26.2...v0.26.4
